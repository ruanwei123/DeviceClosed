...
plot(NULL, type = "n", xlim = c(1, 0), ylim = c(0, 1), xlab = "1 - Specificity", ylab = "Sensitivity", main = "ROC Curves for capped data")
for (i in 1:6) {
...
# 显示AUC结果数据框
head(auc_results_train_capped[order(auc_results_train_capped$auc, decreasing = TRUE), ], 10)
